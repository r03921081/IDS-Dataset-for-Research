...
feature = ["proto", "service", "sttl", "ct_state_ttl", "ct_dst_sport_ltm"]
...
for i in range(82332):
	if raw_train_data["proto"][i] in proto_table:
		raw_train_data["proto"][i] = proto_table[raw_train_data["proto"][i]]
	else:
		raw_train_data["proto"][i] = 0
	if raw_train_data["service"][i] in service_table:
		raw_train_data["service"][i] = service_table[raw_train_data["service"][i]]
	else:
		raw_train_data["service"][i] = 0
	if raw_train_data["state"][i] in state_table:
		raw_train_data["state"][i] = state_table[raw_train_data["state"][i]]
	else:
		raw_train_data["state"][i] = 0

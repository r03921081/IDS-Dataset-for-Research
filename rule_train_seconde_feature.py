...
break_raw_train_data = pd.read_csv("unsw/UNSW_Discretize_Second_Turn.csv", delimiter=',', encoding="utf-8-sig")
print(break_raw_train_data.columns)

old_raw_train_data = break_raw_train_data.drop(["Unnamed: 0", "dload", "is_sm_ips_ports", "synack", "sttl"], axis = 1)
